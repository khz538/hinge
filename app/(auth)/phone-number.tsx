    ...
    return (
        <>
            <View style={styles.content}>
                ...
                <Spacer size={10} />
                <Type variant="displayLarge">
                    What's your phone number?
                </Type>
                <Spacer size={70} />
                <PhoneInput />
                <Type variant="bodySmall" color="grey2">Hinge will send you a text with a verification code. Message and data rates may apply.</Type>
                <Spacer size={40} />
                <Link href={{
                    ...
                    <Type variant="bodySmallBold" color="primaryDark">What if my number changes?</Type>
                </Link>
            </View>
